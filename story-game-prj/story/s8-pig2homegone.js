// 클래스명 바꿔주기
export default class Pig2HomeGone{
  ...
  constructor() {
    ...
    this.img = new Image();
    this.img.src = "../img/S8.jpg";
    
    // 오디오 파일 불러오기 (src 임시) , .loop 자동반복 false로 막음
    this.audio = new Audio();
    this.audio.src = "../audio/sound/scene8.mp3";
    ...
    this.subtitleTxt = ['집을 잃은 첫째 돼지는 곧바로 둘째 돼지 집으로 도망왔어요.',
                        '그 뒤를 쫓아온 늑대는 다시 물었어요',
                        '"꼬마 돼지들아, 나 좀 들여보내줘."',
                        '두 형제는 이번에도 문을 꼭 붙잡고선 말했어요.',
                        '"안 돼! 우리를 내버려 둬!"',
                        '그러자 이번에도 늑대는 입김을 모으기 시작했어요.',
                        ' "후우우우 훅훅~!"',
                        '이번에도 늑대는 입김을 훅 불어 나무로 만든',
                        '둘째 돼지 집을 휙 날려버렸어요.']; /*여기다가 멘트들 한줄씩 넣으면 됨*/
